...
public class TutorialsNinjaSteps extends BaseClass {
    static TutorialsNinjaPage page;

    String excelPath = "C:\\Users\\User\\Desktop\\SDET_Wipro\\TutorialsNinjaBDD\\TestData\\TutorialsNinja_RegisterUserData.xlsx";
    ...
    public void registerUser() throws Exception {
        ...
        String email = "testselenium34534@gmail.com";
        ...
        fos.close();
        workbook.close();
        page.register(fname,lname,email,phone,pass,confirmPass);
    }
